          ...
          <div className="row gy-3 p-b-5">
            ...
            >
              <div className="service-box boxwhite">
                <h3 id="title-white">
                  <i className="fas fa-users me-3"></i>Equipos dedicados
                </h3>
                <p>
            ...
            >
              <div className="service-box">
                <h3>
                  <i className="fas fa-tools me-3"></i>Desarrollo de MVPs
                </h3>
                <p>
            ...
            >
              <div className="service-box">
                <h3>
                  <i className="fas fa-globe me-3"></i>Desarrollo de Apps
                </h3>
                <p>
            ...
            >
              <div className="service-box boxwhite">
                <h3 id="title-white">
                  <i className="fas fa-cogs me-3"></i>Desarrollo de servicios
                </h3>
                <p>
